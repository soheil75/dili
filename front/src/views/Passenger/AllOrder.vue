        ...
        <div class="row">
            <div class="col-12 col-md-6 m-md-auto">
                ...
                <div class="wares mt-3">
                    <router-link :to="'/OrderDetailsPass/'+ ware.id " v-for="(ware, index) in wares" :key="index">
                        <div class="ware">
                            <div class="img-box">
                            ...
                            <div class="text-box">
                                ...
                                <h4>کاربر : <span>{{ ware.username }}</span></h4>
...
export default {
    ...
    methods: {
        getwares() {
            const path = 'http://localhost:5000/api/allorder';
            axios.get(path)
                .then((res) => {
